...
.. code-block:: console
   ...
   nextron@cockpit:~$ sudo openssl req -new -newkey rsa:4096 -days 182 -nodes -x509 -subj "/O=Nextron Systems GmbH/CN=$(hostname --fqdn)" -keyout /etc/asgard-analysis-cockpit/http.key -out /etc/asgard-analysis-cockpit/http.pem
   nextron@cockpit:~$ sudo chown -R analysiscockpit: /etc/asgard-analysis-cockpit
