...
.. figure:: ../images/nx_iso_installer.png
   :alt: Starting the installation

   Starting the installation

.. figure:: ../images/nx_iso_installer_language.png
   :alt: Choosing language, location and locales I

.. figure:: ../images/nx_iso_installer_location.png
   :alt: Choosing language, location and locales II

.. figure:: ../images/nx_iso_installer_locales.png
   :alt: Choosing language, location and locales III

.. figure:: ../images/nx_iso_installer_locales2.png
...
.. note:: 
    ...
    automatically. Without DHCP, the installer proceeds with the manual
