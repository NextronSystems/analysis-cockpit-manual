...
Welcome to Nextron System's Manual for the Analysis Cockpit v4.
...
events and SIGMA matches generated by Management Centers endpoint
agents.

It can be used in an environment where scans results can be
automatically collected from the Management Centers, scan
results originating from your THOR Cloud account, or environments
in which THOR is executed by scripts or any other 3rd party solution.
